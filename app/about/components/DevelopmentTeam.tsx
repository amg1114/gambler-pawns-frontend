...
const DeveloperCard: React.FC<DeveloperCardProps> = ({ username, avatar }) => (
  <div className="flex flex-col items-center">
    <Image src={avatar} alt={username} className="w-3xl h-3xl rounded-full mb-2 " />
    <div className="flex items-center">
        <a href={`https://github.com/${username}`}>
      <Image src={githubIcon} alt='githubIcon' className="mr-xs size-lg" />
        </a>
        <a href={`https://github.com/${username}`}>
...
const developers: Developer[] = [
    { username: "xX_Monsalve", avatar: aguacate },
  ...
  return (
    <div className="w-full bg-primary p-6 rounded-lg rounded-t-full mt-3xl">
      <StyledTitle variant="h1" extraClasses="text-center pt-xl !text-dark-2"> EQUIPO DE DESARROLLO</StyledTitle>
