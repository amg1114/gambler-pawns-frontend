  ...
  return (
    <section className="space-y-xl py-xl">
      ...
      <article className="border-b border-light pb-md">
        ...
        <StyledParagraph>
          After much deliberation, we’ve come to the conclusion of using{" "}
          <span className={bungee.className}>Bungee</span> as our primary font,
          as it evokes a playful, game-like aesthetic. For our secondary font,
          we chose{" "}
          <span className={`${azeret_mono.className} font-bold`}>
            Azeret_Mono
          </span>
          , which brings a retro and arcade-inspired vibe. Lastly, we opted for{" "}
          <span className="underline">Nunito</span> as our flat font due to its
        ...
        <div className="grid grid-cols-2 gap-md">
          ...
          <article>
            <StyledParagraph>
              ...
              dolorum quasi deserunt sint ullam ut quam, dolorem eum quas
              beatae.
            </StyledParagraph>
      ...
      <article className="">
        ...
        <div className="flex flex-wrap gap-sm">
          ...
          <StyledButton variant="secondary">Secondary Filled</StyledButton>
          <StyledButton style="outlined">Primary Outlined</StyledButton>
