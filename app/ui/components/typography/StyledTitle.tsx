...
const styleClasses = {
    ...
    h2: {className: `text-2xl font-semibold mb-lg`, fontFamily: azeret_mono.className},
    h3: {className: `text-xl font-semibold mb-md`, fontFamily: azeret_mono.className},
    h4: {className: `text-xl font-semibold mb-sm`, fontFamily: azeret_mono.className},
};
